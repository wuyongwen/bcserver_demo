...
<!-- So that mobile webkit will display zoomed in --><meta name="format-detection" content="telephone=no">
<!-- disable auto telephone linking in iOS --><title>Welcome to Beauty Circle!</title>
										...
										<tbody>
											...
											<tr>
												<td bgcolor="#FFFFFF" class="content-block-guidelines" style="font-family: sans-serif; text-align:left; font-size: 16px; line-height: 24px; color: #333333; border-collapse: collapse; padding: 0px 20px 20px;">
													<p class="content-title" style="font-size: 24px;  color: #333333; line-height: 34px; margin: 18px 0 18px; padding: 0;"> ${actionBean.deactivateTitleLabel} </p>
													${actionBean.deactivateContentLabel1}
													<span style="color:#ad57a2; font-weight:bold;">${actionBean.email}</span>
													${actionBean.deactivateContentLabel2}<br><br>
													<table border="0" align="left" style="text-decoration:none;" cellpadding="0" cellspacing="0">
														<tbody>
															<tr>
																<td style="line-height:25px; padding:5px; background:#CCCCCC;  text-align:left">
																	<a href="/api/user/confirm-mail.action?remove2&memberId=${actionBean.memberId}&locale=${actionBean.locale}" style="color:#333333; text-decoration:none">${actionBean.deactivateButtonLabel} &gt;&gt;</a>
																</td>
															</tr>
														</tbody>
													</table><br>
