...
<body>
	...
	<s:form beanclass="com.cyberlink.cosmetic.action.api.product.CreateProductAction">
		<label>locale: <s:text name="locale" size="20" value="zh_TW"/></label><br/>
		<label>brandID: <s:text name="brandID" size="20" /></label><br/>
		<label>storeID: <s:text name="storeID" size="60" /></label><br/>
		<label>typeGroupID: <s:text name="typeGroupID" size="20" value="1"/></label><br/>
	    ...
	    <label>typeID: <s:text name="typeID" size="20" /></label><br/>
		<label>typeID: <s:text name="typeID" size="20" /></label><br/>
		<label>typeID: <s:text name="typeID" size="20" /></label><br/>
