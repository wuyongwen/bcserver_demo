...
@UrlBinding("/api/product/add-collection.action")
public class AddCollectionAction extends AbstractAction{
    ...
    public Resolution route() {
        ...
        if (collection == null) {
            ...
            collection.setUserId(session.getUserId());
            collection.setTarget(targetList);
        } else {
            collection.setIsDeleted(Boolean.FALSE);
        }
