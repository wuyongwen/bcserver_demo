...
public class MailJoinEventStoreServiceImpl extends AbstractMailService
		implements MailJoinEventStoreService, ApplicationEventPublisherAware {

	private BrandEventDao brandEventDao;
	private EventUserDao eventUserDao;

	protected MailJoinEventStoreServiceImpl() {
		super(MailType.JOIN_EVENT_STORE);
	}
	...
	public void send(Long eventUserId, Long brandEventId) {
		...
		final EventReceiveData receiveData = new EventReceiveData(brandEvent, eventUser);
