...
public class MailImpersonationSuspensionServiceImpl extends AbstractMailService
		implements MailImpersonationSuspensionService,
		ApplicationEventPublisherAware {

	protected MailImpersonationSuspensionServiceImpl() {
		super(MailType.IMPERSONATION_SUSPENSION);
	}
		...
		try {
			...
			if (locale.getLanguage().equalsIgnoreCase("en")) {
				return LanguageCenter.getMailLang(region)
						.getSubjectImpersonationSuspension();
			}
		} catch (Exception e) {
		}
