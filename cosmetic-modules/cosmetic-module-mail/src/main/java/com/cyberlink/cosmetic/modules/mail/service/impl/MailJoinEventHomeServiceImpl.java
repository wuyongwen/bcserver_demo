...
public class MailJoinEventHomeServiceImpl extends AbstractMailService implements
		MailJoinEventHomeService, ApplicationEventPublisherAware {

	private BrandEventDao brandEventDao;
	private EventUserDao eventUserDao;

	protected MailJoinEventHomeServiceImpl() {
		super(MailType.JOIN_EVENT_HOME);
	}
