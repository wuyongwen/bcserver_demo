...
<style>
    ...
    .msg{padding:10px 20px; line-height:150%; background:#eeeeee}
</style>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="word-break: break-word; -webkit-text-size-adjust: none; -ms-text-size-adjust: none;  margin: 0; padding: 0;">
<style type="text/css">
a:visited {
...
<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%">
  ...
  <table border="0" width="${mailWidth}" cellpadding="0" cellspacing="0" align="center" class="email-container" style="margin-top: 0px; border-spacing: 0; border: 0px;"><tr>
  <td>
              <#nested/>
  </td></tr>
  </table>
...
<table border="0" width="${mailWidth}" cellpadding="0" cellspacing="0" align="center" class="email-container" bgcolor="#666666" style="border-spacing: 0;">
  <tr>
