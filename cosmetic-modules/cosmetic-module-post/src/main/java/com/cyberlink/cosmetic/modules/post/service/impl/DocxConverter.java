...
public class DocxConverter {
    ...
    public DocxConverter( String filePath, String output) throws IOException, InvalidFormatException, ParserConfigurationException{    
        ...
        if(!folder.canRead())
                folder.mkdirs();
        folder = null;
        imgPath = filePath.substring(0, pos).concat(File.separator).concat(IMG_FOLDER);
    ...
    public static String convert(String path, String output) throws Exception{
        ...
        return converter.saveAsHtml(output, converter.htmlDocumentFacade.getDocument());
    }
    ...
    private String saveAsHtml(String output,Document document) throws IOException, TransformerException{
