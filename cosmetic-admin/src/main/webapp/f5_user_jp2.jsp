...
try {
	...
	returnJson = urlContentReader.post("https://" + websiteDomain + "/api/user/sign-in-BC.action?uuid=3_xnuz7y96C803LcshgeFXBVOen3D-bJVhoYhdKfPvw~&locale=en_US&apnsType=apns&apnsToken=null", params);
	...
	returnJson = urlContentReader.post("https://" + websiteDomain + "/api/user/info.action?uuid=3_xnuz7y96C803LcshgeFXBVOen3D-bJVhoYhdKfPvw~", params);
	contentMap = objectMapper.readValue(returnJson, Map.class);
    ...
    returnJson = urlContentReader.post("https://" + websiteDomain + "/api/user/update.action", params);
	contentMap = objectMapper.readValue(returnJson, Map.class);
    ...
    returnJson = urlContentReader.post("http://" + websiteDomain + "/api/user/list-user-byType.action?locale=en_US", params);
	contentMap = objectMapper.readValue(returnJson, Map.class);
	...
	params = new HashMap<String, String>();
	params.put("method", "GET");
    returnJson = urlContentReader.post("http://" + websiteDomain + "/api/user/list-default-cover.action", params);
	contentMap = objectMapper.readValue(returnJson, Map.class);
	mapArray = (List<Map<String, Object>>) contentMap.get("results");
	if (!mapArray.get(0).containsKey("id")) {
		out.print("fail");
